...
export const PATCH = async (request: Request, context: { params: any }) => {
    ...
    try {
        ...
        // validate if the userId exist and is valid.
        if (!userId) {
        ...
        return new NextResponse(JSON.stringify({ message: "Error in updating category" + error.message }), { status: 500 });
    }
};
...
export const DELETE = async (request: Request, context: { params: any }) => {
    ...
    try {
        ...
        return new NextResponse(JSON.stringify({ message: "Error in deleting category" + error.message }), { status: 500, });
    }
}
